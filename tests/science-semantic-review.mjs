...
const matterCycleIds=["g5s-011","g5s-015","g5s-016","g5s-div-b007","g5s-div-b008","g5s-div-b010","g5s-div-b012","g5s-cap-007","g5s-cap-008","g5s-cap-009","g5s-cr-003"];
...
console.log(`PASS: Grade 5 Science source bank retains ${Object.keys(G5_STANDARD_CORRECTIONS).length} consolidated standard corrections, ${consolidatedPromptRepairIds.length} semantic prompt repairs, and ${consolidatedTellRepairIds.length} answer-tell balances with source-defined expectation coverage.`);
